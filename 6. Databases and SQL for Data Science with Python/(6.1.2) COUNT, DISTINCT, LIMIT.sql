...
/* Retrieve the name of the first 50 films distinctly. */
SELECT DISTINCT Title 
...
/* Retrieve the next 3 film names distinctly after the first 5 films released in 2015. */
SELECT DISTINCT Title 
FROM FilmLocations 
